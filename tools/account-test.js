...
section('3) فرض تغيير كلمة المرور المؤقتة عند أول دخول');
{
  ...
  throws('الخادم يرفض saveBeneficiary طالما لم تُغيَّر كلمة المرور المؤقتة (لا تجاوز عبر API مباشر)', () =>
    S.saveBeneficiary(token, { deviceTypes: ['ثلاجة'], name: 'تجاوز', region: 'الرياض', city: 'الرياض', address: 'حي', district: 'حي الاختبار', phone: '0500000099', familyCount: 1, socialStatus: 'أرملة', needs: [] }),
