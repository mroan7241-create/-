...
function runScenario(count) {
  ...
  resetPerCallCache();
  const save = timeIt(() => S.saveBeneficiary(token, { deviceTypes: ['ثلاجة'],
    name: 'مستفيد جديد للقياس', region: 'الرياض', city: 'الرياض', address: 'حي', district: 'حي الاختبار',
    phone: '0500055555', familyCount: 2, socialStatus: 'أرملة', needs: ['ثلاجة'], lat: '24.7', lng: '46.6'
  }));
