...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/admin/selection', label: 'التقييم والاختيار', icon: Target, roles: ['ADMIN'], available: true, group: 'نظرة عامة' },
  { href: '/admin/applications', label: 'طلبات الانضمام', icon: Inbox, roles: ['ADMIN'], available: true, group: 'إدارة البرنامج' },
  { href: '/admin/operations', label: 'دورات العمل', icon: Workflow, roles: ['ADMIN'], available: true, group: 'إدارة البرنامج' },
  ...
  { href: '/association/operations', label: 'دورات العمل', icon: Workflow, roles: ['ASSOCIATION'], available: true, group: 'نظرة عامة' },
