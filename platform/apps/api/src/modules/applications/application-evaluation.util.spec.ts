...
describe('locked application evaluation', () => {
  it('uses exactly the approved 100-point weights', () => {
    ...
    expect(scoreApplication({ operationalReadiness: 100, technicalCapability: 100, previousExperience: 100, integrityTransparency: 100, participationCommitment: 100, sustainabilityImpact: 100, geographicProjectNeed: 100 }).total).toBe(100);
  });
  it('breaks ties deterministically without adding geographic points', () => {
    const ranked = rankApplications([
      { id: 'b', score: 80, operationalReadiness: 90, technicalCapability: 80, geographicProjectNeed: 90 },
      { id: 'a', score: 80, operationalReadiness: 90, technicalCapability: 80, geographicProjectNeed: 90 },
      { id: 'c', score: 80, operationalReadiness: 80, technicalCapability: 100, geographicProjectNeed: 100 },
    ]);
